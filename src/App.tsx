...
import { todosAtom, addTodoAtom, deleteTodoAtom, fetchTodosAtom } from './atoms';
    ...
    <section className="h-screen w-screen bg-slate-800 flex items-center justify-center">
      <div className="max-w-lg w-full bg-white rounded-xl overflow-hidden shadow-lg px-5 py-8">
        <header className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900"><Inbox className="fill-blue-500 inline-block mb-1 mr-2" />Inbox</h1>
        </header>
